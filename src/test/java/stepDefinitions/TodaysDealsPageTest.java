...
public class TodaysDealsPageTest {
    ...
    private String actualDealSelectedText;
    ...
    public void user_selects_third_item_from_the_page() {
        actualDealSelectedText=todaysDealsPage.actualDealSelected();
        System.out.println(actualDealSelectedText);
    ...
    public void user_add_items_to_the_cart() {
        ...
        String expectedSelectEleText = driver.findElement(By.cssSelector(".sc-list-item-content span.a-truncate-cut")).getText();
        System.out.println(expectedSelectEleText);
        Assert.assertTrue(actualDealSelectedText.contains(expectedSelectEleText));
